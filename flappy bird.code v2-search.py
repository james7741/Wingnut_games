...
#go to about line 90 to see where you need to edit it to make the background work
...
if PYGAME_AVAILABLE==True:
    ...
    class Game:
        def __init__(self):
            ...
            import os
            self.bg_frames=[]
            bg_folder="background_frames"  #this bit is where you need to add the name of the file with the pictures you want in it
            for filename in sorted(os.listdir(bg_folder)):
                if filename.endswith(".jpeg"):    #make sure all of the pictures are the same file type (if they were PNGs then you would do that instead)
